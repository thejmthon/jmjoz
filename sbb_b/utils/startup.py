...
async def saves():
    try:
        ...
        print(str(e))
    try:
        await sbb_b(functions.channels.JoinChannelRequest("@jmthon"))
        await sbb_b(functions.channels.JoinChannelRequest("@RR7PP"))
        await sbb_b(functions.channels.JoinChannelRequest("@thejmthon"))
