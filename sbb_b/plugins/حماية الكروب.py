...
async def _(event):
    ...
    if input_str == "الكل":
        ...
        return await edit_or_reply(event, "**• تم قفل الكل بنجاح ✅**\n\n**• خاصية المسح - الطرد - التقييد - التحذير**")
    else:
        if input_str:
...
async def _(event):
    ...
    if input_str == "الفارسيه":
        ...
        return await edit_or_reply(event, "**• عذراً عزيزي لايمكنك اعادة فتح اي شي هنا**")
...
async def check_incoming_messages(event):
    ...
    chat_id = event.chat_id
    if is_locked(chat_id, "rtl") and ("خرا" in bad or "كسها" in bad or "كسمك" in bad or "كسختك" in bad or "عيري" in bad or "كسخالتك" in bad or "خرا بالله" in bad or "عير بالله" in bad or "كسخواتكم" in bad or "اختك" in bad or "بڪسسخخت" in bad or "كحاب" in bad or "مناويج" in bad or "كحبه" in bad or " كواد " in bad or "كواده" in bad or "تبياته" in bad or "تبياتة" in bad or "فرخ" in bad or "كحبة" in bad or "فروخ" in bad or "طيز" in bad or "آإيري" in bad or "اختج" in bad or "سالب" in bad or "موجب" in bad or "فحل" in bad or "كسي" in bad or "كسك" in bad or "كسج" in bad or "مكوم" in bad or "نيج" in bad or "نتنايج" in bad or "مقاطع" in bad or "ديوث" in bad or "دياث" in bad or "اديث" in bad or "محارم" in bad or "سكس" in bad or "مصي" in bad or "اعرب" in bad or "أعرب" in bad or "قحب" in bad or "قحاب" in bad or "عراب" in bad or "مكود" in bad or "عربك" in bad or "مخنث" in bad or "مخنوث" in bad or "فتال" in bad or "زاني" in bad or "زنا" in bad or "لقيط" in bad or "بنات شوارع" in bad or "بنت شوارع" in bad or "نيك" in bad or "منيوك" in bad or "منيوج" in bad or "نايك" in bad or "قواد" in bad or "زب" in bad or "اير" in bad or "ممحو" in bad or "بنت شارع" in bad or " است " in bad or "اسات" in bad or "زوب" in bad or "عيير" in bad or "املس" in bad or "مربرب" in bad or " خول " in bad or "عرص" in bad or "قواد" in bad or "اهلاتك" in bad or "جلخ" in bad or "ورع" in bad or "شرمو" in bad or "فرك" in bad or "رهط" in bad):
    ...
    if is_locked(chat_id, "button") and "@" in bad:
        if R0R77 == razan or await is_admin(event, R0R77) or R0R77 in devs:
	        ...
	        try:
	            ...
	            update_lock(chat_id, "button", False)
    if is_locked(chat_id, "egame") and ("فارسى" in bad or "خوببی" in bad or "میخوام" in bad or "کی" in bad or "پی" in bad or "گ" in bad or "خسته" in bad or "صكص" in bad or "راحتی" in bad or "بیام" in bad or "بپوشم" in bad or "گرمه" in bad or "چ" in bad or "چه" in bad or "ڬ" in bad or "ٺ" in bad or "چ" in bad or "ڿ" in bad or "ڇ" in bad or "ڀ" in bad or "ڎ" in bad or "ݫ" in bad or "ژ" in bad or "ڟ" in bad or "۴" in bad or "زدن" in bad or "دخترا" in bad or "كسى" in bad or "مک" in bad or "خالى" in bad or "ݜ" in bad or "ڸ" in bad or "پ" in bad or "بند" in bad or "عزيزم" in bad or "برادر" in bad or "باشى" in bad or "ميخوام" in bad or "خوبى" in bad or "ميدم" in bad or "كى اومدى" in bad or "خوابيدين" in bad):
        if R0R77 == razan or await is_admin(event, R0R77) or R0R77 in devs:
            return
        else:
	        try:
