...
async def chat_blacklist(event):
    ...
    if input_str == "تفعيل":
        ...
        text += "**انت بم تقم باضافة اي شخص الى قائمة المتحكمين بالأصل ارسل `.امر التحكم`**"
