...
from . import edit_delete, edit_or_reply, jmisbest, mention
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m jmisbest`",
        "**State changed from starting to up**",
        "__INFO:jmisbest:Logged in as 557667062__",
        "__INFO:jmisbest:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
...
@jmisbest.on(admin_cmd(pattern="احبك"))
async def rz(jmisbest):
    roz = random.choice(love)
    return await edit_or_reply(jmisbest, roz)
