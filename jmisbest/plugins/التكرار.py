...
@jmisbest.ar_cmd(pattern="كرر ([\s\S]*)")
...
@jmisbest.ar_cmd(pattern="spspam$")
...
@jmisbest.ar_cmd(pattern=f"{TKRAR} (.*)")
async def spammer(event):
    reply = await event.get_reply_message()
...
@jmisbest.ar_cmd(pattern="تعبير مكرر$")
...
@jmisbest.ar_cmd(pattern="ايقاف التكرار ?(.*)")
