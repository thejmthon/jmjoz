...
from . import edit_delete, edit_or_reply, jmisbest, progress
...
@jmisbest.ar_cmd(pattern="زايب(?:\s|$)([\s\S]*)")
...
@jmisbest.ar_cmd(pattern="تار(?:\s|$)([\s\S]*)")
...
@jmisbest.ar_cmd(pattern="ان زايب(?:\s|$)([\s\S]*)")
async def zip_file(event):
...
@jmisbest.ar_cmd(pattern="ان تار(?:\s|$)([\s\S]*)")
