...
@jmisbest.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump  is One of the Popular jmisbest",
    },
)
...
@jmisbest.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Catjmisbest is One of the Popular jmisbest",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@jmisbest.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna  is One of the Popular jmisbest",
    },
)
async def nekobot(cat):
...
@jmisbest.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; is One of the Popular jmisbest",
    },
)
async def nekobot(cat):
