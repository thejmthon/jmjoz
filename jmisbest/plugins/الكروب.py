...
@jmisbest.ar_cmd(pattern="المشرفين(?: |$)(.*)")
async def _(event):
...
@jmisbest.ar_cmd(pattern="البوتات(?: |$)(.*)")
async def _(event):
...
@jmisbest.ar_cmd(pattern="الاعضاء(?: |$)(.*)")
async def get_users(show):
    ...
    jmisbestevent = await edit_or_reply(show, "**⌔∮ جاري سحب قائمة معرّفات الأعضاء 🝛**")
    try:
        ...
        mentions += " " + str(e) + "\n"
    await edit_or_reply(jmisbestevent, mentions)
...
async def info(event):
    ...
    try:
        await jmisbestevent.edit(caption, parse_mode="html")
    except Exception as e:
        if BOTLOG:
            await event.client.send_message(
                BOTLOG_CHATID, f"**⌔∮ هناك خطأ في معلومات الدردشة ✕ : **\n`{str(e)}`"
            )
        await jmisbestevent.edit("**⌔∮ حدث خطأ ما، يرجى التحقق من الأمر ⎌**")


async def get_chatinfo(event, jmisbestevent):
    ...
    try:
        ...
        try:
            ...
            await jmisbestevent.edit("**⌔∮ لم يتمّ العثور على القناة/المجموعة ✕**")
            return None
        except ChannelPrivateError:
            await jmisbestevent.edit(
                "**⌔∮ هذه مجموعة أو قناة خاصة أو لقد تمّ حظري منه ⛞**"
            )
            return None
        except ChannelPublicGroupNaError:
            await jmisbestevent.edit("**⌔∮ القناة أو المجموعة الخارقة غير موجودة ✕**")
            return None
        except (TypeError, ValueError) as err:
            await jmisbestevent.edit(str(err))
            return None
    return chat_info
