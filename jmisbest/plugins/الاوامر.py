...
@jmisbest.ar_cmd(pattern="الاوامر")
async def hi(event):
    await edit_or_reply(
        event,
...
@jmisbest.ar_cmd(pattern="الامر1")
async def hi(event):
    await edit_or_reply(
        event,
...
@jmisbest.ar_cmd(pattern="الامر2")
async def hi(event):
    await edit_or_reply(
        event,
