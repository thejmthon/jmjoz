...
@jmrobot.ar_cmd(pattern="ايقاف الصيد")
async def _(event):
    if "on" in isclaim:
        isclaim.clear()
        isclaim.append("off")
...
@jmrobot.ar_cmd(pattern="ايقاف التثبيت")
async def _(event):
    if "on" in isauto:
        isauto.clear()
        isauto.append("off")
...
@jmrobot.ar_cmd(pattern="حالة الصيد")
async def _(event):
    if "on" in isclaim:
...
@jmrobot.ar_cmd(pattern="حالة التثبيت")
async def _(event):
    if "on" in isauto:
