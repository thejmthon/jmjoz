...
from . import edit_delete, edit_or_reply, jmrobot, mention
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m jmrobot`",
        "**State changed from starting to up**",
        "__INFO:jmrobot:Logged in as 557667062__",
        "__INFO:jmrobot:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
...
@jmrobot.on(admin_cmd(pattern="احبك"))
async def rz(jmrobot):
    roz = random.choice(love)
    return await edit_or_reply(jmrobot, roz)
