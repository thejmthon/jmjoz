...
@jmrobot.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump  is One of the Popular jmrobot",
    },
)
...
@jmrobot.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Catjmrobot is One of the Popular jmrobot",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@jmrobot.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna  is One of the Popular jmrobot",
    },
)
async def nekobot(cat):
...
@jmrobot.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; is One of the Popular jmrobot",
    },
)
async def nekobot(cat):
