...
from . import edit_delete, edit_or_reply, jmsource, progress
...
@jmsource.ar_cmd(pattern="زايب(?:\s|$)([\s\S]*)")
...
@jmsource.ar_cmd(pattern="تار(?:\s|$)([\s\S]*)")
...
@jmsource.ar_cmd(pattern="ان زايب(?:\s|$)([\s\S]*)")
async def zip_file(event):
...
@jmsource.ar_cmd(pattern="ان تار(?:\s|$)([\s\S]*)")
