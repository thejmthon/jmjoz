...
@jmsource.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump  is One of the Popular jmsource",
    },
)
...
@jmsource.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Catjmsource is One of the Popular jmsource",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@jmsource.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna  is One of the Popular jmsource",
    },
)
async def nekobot(cat):
...
@jmsource.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; is One of the Popular jmsource",
    },
)
async def nekobot(cat):
