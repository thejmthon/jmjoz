...
from . import edit_delete, edit_or_reply, jmsource, mention
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m jmsource`",
        "**State changed from starting to up**",
        "__INFO:jmsource:Logged in as 557667062__",
        "__INFO:jmsource:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
...
@jmsource.on(admin_cmd(pattern="احبك"))
async def rz(jmsource):
    roz = random.choice(love)
    return await edit_or_reply(jmsource, roz)
