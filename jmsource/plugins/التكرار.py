...
@jmsource.ar_cmd(pattern="كرر ([\s\S]*)")
...
@jmsource.ar_cmd(pattern="spspam$")
...
@jmsource.ar_cmd(pattern=f"{TKRAR} (.*)")
async def spammer(event):
    reply = await event.get_reply_message()
...
@jmsource.ar_cmd(pattern="تعبير مكرر$")
...
@jmsource.ar_cmd(pattern="ايقاف التكرار ?(.*)")
