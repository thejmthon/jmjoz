...
@jmsource.ar_cmd(pattern="كتم(?:\s|$)([\s\S]*)")
...
@jmsource.ar_cmd(pattern="الغاء كتم(?:\s|$)([\s\S]*)")
...
@jmsource.ar_cmd(pattern="الغاء تثبيت( الكل|$)")
