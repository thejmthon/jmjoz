...
from . import edit_delete, edit_or_reply, jmub, mention
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m jmub`",
        "**State changed from starting to up**",
        "__INFO:jmub:Logged in as 557667062__",
        "__INFO:jmub:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
...
@jmub.on(admin_cmd(pattern="احبك"))
async def rz(jmub):
    roz = random.choice(love)
    return await edit_or_reply(jmub, roz)
