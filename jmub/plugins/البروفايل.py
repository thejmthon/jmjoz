...
@jmub.ar_cmd(pattern="وضع بايو ([\s\S]*)")
async def _(event):
...
@jmub.ar_cmd(pattern="وضع اسم ([\s\S]*)")
async def _(event):
...
@jmub.ar_cmd(pattern="وضع يوزر ([\s\S]*)")
...
@jmub.ar_cmd(pattern="ازالة الصورة ?([\s\S]*)")
