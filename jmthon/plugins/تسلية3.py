...
from . import edit_delete, edit_or_reply, mention, jmthon
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m jmthon`",
        "**State changed from starting to up**",
        "__INFO:jmthon:Logged in as 557667062__",
        "__INFO:jmthon:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
