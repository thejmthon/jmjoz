        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            ...
            if pattern is not None:
                ...
                if edited:
                    jmbot.add_event_handler(func, events.MessageEdited(**kwargs))
                jmbot.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                jmbot.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                jmbot.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
