...
@jmbot.ar_cmd(pattern="وضع بايو ([\s\S]*)")
async def _(event):
...
@jmbot.ar_cmd(pattern="وضع اسم ([\s\S]*)")
async def _(event):
...
@jmbot.ar_cmd(pattern="وضع يوزر ([\s\S]*)")
...
@jmbot.ar_cmd(pattern="ازالة الصورة ?([\s\S]*)")
