...
from . import edit_delete, edit_or_reply, jmbot, progress
...
@jmbot.ar_cmd(pattern="زايب(?:\s|$)([\s\S]*)")
...
@jmbot.ar_cmd(pattern="تار(?:\s|$)([\s\S]*)")
...
@jmbot.ar_cmd(pattern="ان زايب(?:\s|$)([\s\S]*)")
async def zip_file(event):
...
@jmbot.ar_cmd(pattern="ان تار(?:\s|$)([\s\S]*)")
