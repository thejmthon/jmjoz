...
@jmbot.ar_cmd(pattern="ملصق(?:\s|$)([\s\S]*)")
async def kang(args):
    photo = None
    emojibypass = False
    is_anim = False
...
@jmbot.ar_cmd(pattern="حزمة(?:\s|$)([\s\S]*)")
...
@jmbot.ar_cmd(pattern="تحويل بملصق(?:\s|$)([\s\S]*)")
...
@jmbot.ar_cmd(pattern="معلومات_ألملصق$")
