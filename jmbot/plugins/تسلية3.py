...
from . import edit_delete, edit_or_reply, jmbot, mention
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m jmbot`",
        "**State changed from starting to up**",
        "__INFO:jmbot:Logged in as 557667062__",
        "__INFO:jmbot:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
...
@jmbot.on(admin_cmd(pattern="احبك"))
async def rz(jmbot):
    roz = random.choice(love)
    return await edit_or_reply(jmbot, roz)
