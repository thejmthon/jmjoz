...
@jmbot.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump  is One of the Popular jmbot",
    },
)
...
@jmbot.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Catjmbot is One of the Popular jmbot",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@jmbot.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna  is One of the Popular jmbot",
    },
)
async def nekobot(cat):
...
@jmbot.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; is One of the Popular jmbot",
    },
)
async def nekobot(cat):
