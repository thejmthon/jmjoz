...
from . import edit_delete, edit_or_reply, jmisgood, progress
...
@jmisgood.ar_cmd(pattern="زايب(?:\s|$)([\s\S]*)")
...
@jmisgood.ar_cmd(pattern="تار(?:\s|$)([\s\S]*)")
...
@jmisgood.ar_cmd(pattern="ان زايب(?:\s|$)([\s\S]*)")
async def zip_file(event):
...
@jmisgood.ar_cmd(pattern="ان تار(?:\s|$)([\s\S]*)")
