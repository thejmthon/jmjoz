...
@jmisgood.ar_cmd(pattern="كرر ([\s\S]*)")
...
@jmisgood.ar_cmd(pattern="spspam$")
...
@jmisgood.ar_cmd(pattern=f"{TKRAR} (.*)")
async def spammer(event):
    reply = await event.get_reply_message()
...
@jmisgood.ar_cmd(pattern="تعبير مكرر$")
...
@jmisgood.ar_cmd(pattern="ايقاف التكرار ?(.*)")
