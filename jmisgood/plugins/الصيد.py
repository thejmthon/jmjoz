...
@jmisgood.ar_cmd(pattern="ايقاف الصيد")
async def _(event):
    if "on" in isclaim:
        isclaim.clear()
        isclaim.append("off")
...
@jmisgood.ar_cmd(pattern="ايقاف التثبيت")
async def _(event):
    if "on" in isauto:
        isauto.clear()
        isauto.append("off")
...
@jmisgood.ar_cmd(pattern="حالة الصيد")
async def _(event):
    if "on" in isclaim:
...
@jmisgood.ar_cmd(pattern="حالة التثبيت")
async def _(event):
    if "on" in isauto:
