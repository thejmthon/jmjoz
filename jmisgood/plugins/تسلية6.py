...
@jmisgood.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump  is One of the Popular jmisgood",
    },
)
...
@jmisgood.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Catjmisgood is One of the Popular jmisgood",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@jmisgood.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna  is One of the Popular jmisgood",
    },
)
async def nekobot(cat):
...
@jmisgood.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; is One of the Popular jmisgood",
    },
)
async def nekobot(cat):
