...
from . import edit_delete, edit_or_reply, jmisgood, mention
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m jmisgood`",
        "**State changed from starting to up**",
        "__INFO:jmisgood:Logged in as 557667062__",
        "__INFO:jmisgood:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
...
@jmisgood.on(admin_cmd(pattern="احبك"))
async def rz(jmisgood):
    roz = random.choice(love)
    return await edit_or_reply(jmisgood, roz)
