        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            ...
            if pattern is not None:
                ...
                if edited:
                    jmisgood.add_event_handler(func, events.MessageEdited(**kwargs))
                jmisgood.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                jmisgood.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                jmisgood.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
