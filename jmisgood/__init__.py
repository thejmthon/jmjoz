...
from .core.session import jmisgood, tgbot
...
__author__ = "سورس جمثون <https://github.com/jmthonen/jmisgood0>"
__copyright__ = f" حقوق سورس جمثون (C) 2020 - 2022  {__author__}"

jmisgood.version = __version__
jmisgood.tgbot.version = __version__
